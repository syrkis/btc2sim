...
from btc2sim.types import BehaviorTree, Status, Compass
# from btc2sim.gps import gps_fn


# %% Behavior Treefunctions
@eqx.filter_jit
def fmap(fns, rng: Array, obs: Obs, env: Env, scene: Scene, gps: Compass, target: Array, bt: BehaviorTree):
...
def leafs_fns(rng: Array, obs: Obs, env: Env, scene: Scene, gps: Compass, target: Array, bt: BehaviorTree):
...
def action_fn(rng, obs: Obs, bt: BehaviorTree, env: Env, scene: Scene, gps: Compass, target: Array):
...
def bt_fn(carry: Tuple[Status, Action, Array], input: Tuple[Status, Action, BehaviorTree, Array]):  # this is wrong
